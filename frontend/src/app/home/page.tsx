    ...
    return(
        <div>
           ...
           <div className="flex gap-3 my-5 ml-52">
                <div className="w-60">
                   <img src="/image.png" alt="description of image" className="h-80"></img>
                   <p>The Prompt Magazine</p>
                   <p className="font-semibold">120’000₮</p>
                </div>
                <div className="w-60">
                   <img src="/image2.png" className="h-80" alt="description of image"></img>
                   <p>Chunky Glyph Tee</p>
                   <p className="font-semibold">120’000₮</p>
                </div>
                <div className="w-60">
                   <img src="/image3.png" className="h-80" alt="description of image"></img>
                   <p>All Smiles Nalgene</p>
                   <p className="font-semibold">120’000₮</p>
                </div>
                <div className="w-60">
                   <img src="/image4.png" className="h-80" alt="description of image"></img>
                   <p>All Smiles Nalgene</p>
                   <p className="font-semibold">120’000₮</p>
                </div>  
           </div>
